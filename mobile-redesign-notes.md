# Mobile Redesign Reference Notes

- Use a compact two-column card grid on phone widths, with one short title line, a primary value, and a concise directional signal per card.
